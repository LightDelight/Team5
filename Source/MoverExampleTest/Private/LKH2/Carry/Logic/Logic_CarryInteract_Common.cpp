...
bool ULogic_CarryInteract_Common::PreInteractCheck(const FCarryContext &Context) {
...
bool ULogic_CarryInteract_Common::PerformInteraction(const FCarryContext &Context) {
  AActor *TargetActor = GetOwner();
  AActor *Interactor = Context.Interactor;
