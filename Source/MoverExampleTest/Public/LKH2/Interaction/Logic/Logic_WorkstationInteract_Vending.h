...
#include "Logic_WorkstationInteract_Vending.generated.h"
 ...
 * - InteractableComponent 위치에 공급 아이템의 Display(미리보기)를 표시
 *
 * 필요 Stats 태그:
...
class MOVEREXAMPLETEST_API ULogic_WorkstationInteract_Vending
