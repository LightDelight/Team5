...
//AMyPhyTestActor::AMyPhyTestActor()
//{
...
//	bCanBeInCluster = (GetClass() == AMyPhyTestActor::StaticClass());
//}

void AMyPhyTestActor::BeginPlay()
{
	// Since we allow AMyPhyTestActor to specify whether it replicates via bStaticMeshReplicateMovement - per placed instance
...
//FString AMyPhyTestActor::GetDetailedInfoInternal() const
//{
//	return StaticMeshComponent ? StaticMeshComponent->GetDetailedInfoInternal() : TEXT("No_StaticMeshComponent");
//}
//
//void AMyPhyTestActor::SetMobility(EComponentMobility::Type InMobility)
//{
...
//}
//
//void AMyPhyTestActor::Serialize(FArchive& Ar)
//{
//	Super::Serialize(Ar);
//#if WITH_EDITOR
...
//#if WITH_EDITOR
//
//void AMyPhyTestActor::LoadedFromAnotherClass(const FName& OldClassName)
//{
...
//
//
//void AMyPhyTestActor::PostEditChangeChainProperty(FPropertyChangedChainEvent& PropertyChangedEvent)
//{
...
//
//
//bool AMyPhyTestActor::GetReferencedContentObjects(TArray<UObject*>& Objects) const
//{
...
//}
//
//void AMyPhyTestActor::CheckForErrors()
//{
...
//		{
//			if (Overlap.OverlapObjectHandle.IsValid() && Overlap.OverlapObjectHandle != this && Overlap.OverlapObjectHandle.DoesRepresentClass(AMyPhyTestActor::StaticClass()) &&
...
//			{
//				AMyPhyTestActor* A = Overlap.OverlapObjectHandle.FetchActor<AMyPhyTestActor>();
//				check(A);
//
